...
while 0 > num1 and num2 or num1 and num2 > 1000:
    print("Please enter numbers between 1-999 (inclusive).")
    num1 = int(input("Please enter a value for number1: "))
    num2 = int(input("Please enter a value for number2: "))
...
user_number = int(input("Please enter usernumber (Between 3 and 7 inclusive) : "))

while (user_number <= 2 or user_number >= 8):
    print("Please enter usernumber  (Between 3 and 7 inclusive) !")
    user_number = int(input("Enter new value: "))

a = (random.choices(words, k=int(user_number)))
print("\nPassword is : " + ''.join(a)[::-1])
...
for i in range(8):
    ...
    if int(user_number) < 5:
        shorter.add(''.join(a)[::-1])
    else:
        longer.add(''.join(a)[::-1])

print("\nShorter set is : ", shorter)
print("\nLonger set is: ", longer)

union = shorter.union(longer)
print("\nUnion set is: ", union)
