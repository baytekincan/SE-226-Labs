...
vector<string> words = {"a", "ability", "able", "about", "above", "accept", "according", "account", "across", "act",
                        ...
                        "between", "beyond", "big", "bill", "billion", "bit", "black", "blood", "blue", "board", "body",
                        ...
                        "door", "down", "draw", "dream", "drive", "drop", "drug", "during", "each", "early", "east",
                        "easy", "eat", "economic", "economy", "edge", "education", "effect", "effort", "eight",
                        ...
                        "green", "ground", "group", "grow", "growth", "guess", "gun", "guy", "hair", "half", "hand",
                        "hang", "happen", "happy", "hard", "have", "he", "head", "health", "hear", "heart", "heat",
                        "heavy", "help", "her", "here", "herself", "high", "him", "himself", "his", "history", "hit",
                        "hold", "home", "hope", "hospital", "hot", "hotel", "hour", "house", "how", "however", "huge",
                        ...
                        "rock", "role", "room", "rule", "run", "safe", "same", "save", "say", "scene", "school",
                        ...
                        "short", "shot", "should", "shoulder", "show", "side", "sign", "significant", "similar",
                        ...
                        "source", "south", "southern", "space", "speak", "special", "specific", "speech", "spend",
                        ...
                        "such", "suddenly", "suffer", "suggest", "summer", "support", "sure", "surface", "system",
                        ...
                        "those", "though", "thought", "thousand", "threat", "three", "through", "throughout", "throw",
...
string passGen(int user_number) {
    ...
    std::sample(words.begin(), words.end(), back_inserter(sample), user_number,
...
string rep_with_upper(string str) {
    ...
    int random_letter = rand() % str.length();
    newPassword[random_letter] = toupper(newPassword[random_letter]);
    return newPassword;
}

string swap_letters(string modified) {
    string newModified = modified;
    swap(newModified[0], newModified[newModified.length() - 2]);
    swap(newModified[1], newModified[newModified.length() - 1]);
    return newModified;
}

bool search_letter(string string, char letter) {
    cout << "Searching for letter 'C' ...\nThe result is ";
    for (auto i: string) {
...
int main() {
    ...
    while (true) {
        ...
        cin >> user_number;
        if (user_number >= 8 || user_number <= 2) {
            cout << "Invalid value!\n";
        } else {
            string password = passGen(user_number);
            cout << "\nInitial password is: " << password << endl;
            string upperCased = rep_with_upper(password);
            string swapped = swap_letters(upperCased);
            cout << "\nFinal version of the password: " << swapped << endl << endl;
            cout << boolalpha << search_letter(swapped, 'c' || 'C') << endl;
            break;
        }
    }
    return 0;
